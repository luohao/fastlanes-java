...
public class VectorIntegerPacker {
	...
	public static void pack0(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
		}
	}
	...
	public static void pack1(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			IntVector src;
			IntVector tmp;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 0 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = src;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 128 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 1));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 256 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 2));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 384 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 3));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 512 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 4));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 640 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 5));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 768 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 6));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 896 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 7));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 64 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 8));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 192 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 9));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 320 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 10));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 448 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 11));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 576 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 12));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 704 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 13));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 832 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 14));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 960 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 15));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 32 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 16));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 160 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 17));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 288 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 18));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 416 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 19));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 544 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 20));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 672 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 21));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 800 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 22));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 928 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 23));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 96 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 24));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 224 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 25));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 352 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 26));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 480 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 27));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 608 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 28));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 736 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 29));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 864 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 30));
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 992 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 31));
			tmp.intoArray(output, 0 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack2(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK2);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 30));
			tmp.intoArray(output, 32 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 2);
		}
	}
	...
	public static void pack3(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK3);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 29));
			tmp.intoArray(output, 64 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack4(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK4);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 28));
			tmp.intoArray(output, 96 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 4);
		}
	}
	...
	public static void pack5(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK5);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 27));
			tmp.intoArray(output, 128 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack6(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK6);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 26));
			tmp.intoArray(output, 160 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 6);
		}
	}
	...
	public static void pack7(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK7);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 25));
			tmp.intoArray(output, 192 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack8(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK8);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 24));
			tmp.intoArray(output, 224 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 8);
		}
	}
	...
	public static void pack9(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK9);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 23));
			tmp.intoArray(output, 256 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack10(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK10);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 22));
			tmp.intoArray(output, 288 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 10);
		}
	}
	...
	public static void pack11(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK11);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 21));
			tmp.intoArray(output, 320 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack12(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK12);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 20));
			tmp.intoArray(output, 352 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 12);
		}
	}
	...
	public static void pack13(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK13);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 19));
			tmp.intoArray(output, 384 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack14(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK14);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 18));
			tmp.intoArray(output, 416 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 14);
		}
	}
	...
	public static void pack15(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK15);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 17));
			tmp.intoArray(output, 448 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack16(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK16);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 16));
			tmp.intoArray(output, 480 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 16);
		}
	}
	...
	public static void pack17(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK17);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 15));
			tmp.intoArray(output, 512 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack18(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK18);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 14));
			tmp.intoArray(output, 544 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 18);
		}
	}
	...
	public static void pack19(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK19);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 13));
			tmp.intoArray(output, 576 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack20(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK20);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 12));
			tmp.intoArray(output, 608 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 20);
		}
	}
	...
	public static void pack21(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK21);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 11));
			tmp.intoArray(output, 640 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack22(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK22);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 10));
			tmp.intoArray(output, 672 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 22);
		}
	}
	...
	public static void pack23(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK23);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 9));
			tmp.intoArray(output, 704 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack24(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK24);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 8));
			tmp.intoArray(output, 736 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 24);
		}
	}
	...
	public static void pack25(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK25);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 7));
			tmp.intoArray(output, 768 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack26(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK26);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 6));
			tmp.intoArray(output, 800 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 26);
		}
	}
	...
	public static void pack27(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK27);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 5));
			tmp.intoArray(output, 832 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack28(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK28);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 4));
			tmp.intoArray(output, 864 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 28);
		}
	}
	...
	public static void pack29(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK29);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 3));
			tmp.intoArray(output, 896 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack30(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK30);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 2));
			tmp.intoArray(output, 928 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 30);
		}
	}
	...
	public static void pack31(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK31);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 1));
			tmp.intoArray(output, 960 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack32(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			IntVector src;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 0 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 0 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 128 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 32 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 256 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 64 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 384 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 96 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 512 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 128 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 640 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 160 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 768 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 192 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 896 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 224 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 64 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 256 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 192 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 288 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 320 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 320 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 448 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 352 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 576 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 384 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 704 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 416 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 832 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 448 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 960 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 480 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 32 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 512 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 160 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 544 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 288 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 576 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 416 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 608 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 544 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 640 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 672 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 672 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 800 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 704 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 928 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 736 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 96 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 768 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 224 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 800 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 352 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 832 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 480 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 864 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 608 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 896 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 736 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 928 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 864 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 960 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
			src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, 992 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 992 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
		}
	}
	...
	public static void unpack1(int[] input, int[] output) {
		for (int i = 0; i < 32 / IntVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			IntVector src = IntVector.fromArray(IntVector.SPECIES_PREFERRED, input, i * IntVector.SPECIES_PREFERRED.vectorByteSize());
			IntVector tmp;
			...
			tmp.intoArray(output, 992 + i * IntVector.SPECIES_PREFERRED.vectorByteSize());;
		}
	}
