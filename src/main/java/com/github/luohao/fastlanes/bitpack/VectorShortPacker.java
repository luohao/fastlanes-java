...
public class VectorShortPacker {
	...
	public static void pack0(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
		}
	}
	...
	public static void pack1(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			ShortVector src;
			ShortVector tmp;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 0 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = src;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 128 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 1));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 256 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 2));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 384 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 3));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 512 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 4));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 640 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 5));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 768 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 6));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 896 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 7));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 64 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 8));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 192 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 9));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 320 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 10));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 448 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 11));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 576 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 12));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 704 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 13));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 832 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 14));
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 960 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src = src.and(MASK1);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 15));
			tmp.intoArray(output, 0 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack2(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK2);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 14));
			tmp.intoArray(output, 64 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 2);
		}
	}
	...
	public static void pack3(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK3);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 13));
			tmp.intoArray(output, 128 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack4(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK4);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 12));
			tmp.intoArray(output, 192 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 4);
		}
	}
	...
	public static void pack5(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK5);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 11));
			tmp.intoArray(output, 256 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack6(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK6);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 10));
			tmp.intoArray(output, 320 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 6);
		}
	}
	...
	public static void pack7(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK7);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 9));
			tmp.intoArray(output, 384 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack8(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK8);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 8));
			tmp.intoArray(output, 448 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 8);
		}
	}
	...
	public static void pack9(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK9);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 7));
			tmp.intoArray(output, 512 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack10(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK10);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 6));
			tmp.intoArray(output, 576 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 10);
		}
	}
	...
	public static void pack11(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK11);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 5));
			tmp.intoArray(output, 640 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack12(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK12);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 4));
			tmp.intoArray(output, 704 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 12);
		}
	}
	...
	public static void pack13(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK13);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 3));
			tmp.intoArray(output, 768 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack14(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK14);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 2));
			tmp.intoArray(output, 832 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			tmp = src.lanewise(VectorOperators.LSHR, 14);
		}
	}
	...
	public static void pack15(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			...
			src = src.and(MASK15);
			tmp = tmp.or(src.lanewise(VectorOperators.LSHL, 1));
			tmp.intoArray(output, 896 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
	...
	public static void pack16(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			ShortVector src;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 0 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 0 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 128 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 64 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 256 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 128 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 384 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 192 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 512 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 256 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 640 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 320 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 768 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 384 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 896 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 448 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 64 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 512 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 192 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 576 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 320 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 640 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 448 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 704 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 576 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 768 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 704 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 832 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 832 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 896 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
			src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, 960 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			src.intoArray(output, 960 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
		}
	}
	...
	public static void unpack1(short[] input, short[] output) {
		for (int i = 0; i < 64 / ShortVector.SPECIES_PREFERRED.vectorByteSize(); i++) {
			ShortVector src = ShortVector.fromArray(ShortVector.SPECIES_PREFERRED, input, i * ShortVector.SPECIES_PREFERRED.vectorByteSize());
			ShortVector tmp;
			...
			tmp.intoArray(output, 960 + i * ShortVector.SPECIES_PREFERRED.vectorByteSize());;
		}
	}
